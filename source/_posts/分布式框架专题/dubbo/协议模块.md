...
![http协议head.png](source/uploads/dubbo/Http协议head.png)

### Dubbo 协议报文编码：

![Dubbo协议报文编码.png](source/uploads/dubbo/Dubbo协议报文编码.png)
...
![img.png](source/uploads/dubbo/Dubbo协议报文格式.png)

	*（注：相关源码参见**c**om.alibaba.dubbo.rpc.protocol.dubbo.DubboCodec**）*

### ***Dubbo协议的编解码过程：***

![Dubbo协议的编解码过程.png](source/uploads/dubbo/Dubbo协议的编解码过程.png)
